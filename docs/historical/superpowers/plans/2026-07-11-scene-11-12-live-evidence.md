...
- [x] **Step 1: Add the active roadmap item**
...
- [x] **Step 2: Correct the user-facing presentation description**
...
- [x] **Step 3: Verify the documentation baseline**
...
- [x] **Step 4: Commit the documented baseline**
...
- [x] **Step 1: Add the route regression test**
...
- [x] **Step 3: Synchronize to the resolved target mode**
...
- [x] **Step 4: Verify both boundaries**
...
- [x] **Step 5: Commit the live activation fix**
...
- [x] **Step 3: Add trace-row structure tests**
...
- [x] **Step 4: Implement compact trace rows**
...
- Modify: web/apps/console/src/presentation/InterruptDecisionForm.tsx
- Modify: web/apps/console/src/presentation/RunFactsPanel.tsx
...
- Test: web/apps/console/src/presentation/InterruptDecisionForm.test.tsx

- [x] **Step 1: Add composition assertions**
...
- [x] **Step 2: Implement decision-led markup**
...
- [x] **Step 3: Rebalance the approval grid**
...
- [x] **Step 4: Verify approval interactions**
...
- [x] **Step 1: Add continuation assertions**
...
- [x] **Step 2: Implement resume/output hierarchy**
...
- [x] **Step 3: Implement trace hierarchy and spacing**
...
- [x] **Step 4: Verify all Scene 12 beats at both target sizes**
...
- [x] **Step 2: Run live and replay browser smoke**
...
- [x] **Step 4: Complete roadmap and archive the plan**
...
- [x] Scene 11 has one decision-led primary surface and no output/trace preview.
- [x] Scene 12 has a dominant report on resume/output and compact trace rows on trace.
- [x] Empty/missing trace values remain truthful and visually distinguishable.
- [x] A healthy configured target stays live; an invalid target falls back to replay.
- [x] Replay never calls callOperation.
- [x] One editorial canvas remains the only stage theme.
- [x] README and roadmap no longer claim act-level themes or replay-only Scenes 10-12.
- [x] Full tests, typecheck, build, browser smoke, and review complete before archival.
